...
for file in os.listdir(data_folder):
    if file.endswith('.xlsx'):
        ...
        for index, row in dfd.iterrows():
            ...
            if speaker == 'user' and pd.notna(text):
                ...
                if original_intent == confirmed_intent:
                    intent_flag = 1
                results.append([cid, str_conversation_schedule1, original_intent, confirmed_intent, intent_flag, original_slots, nlu_slots, slot_percentage, whatever_flag_original, whatever_flag_NLU, whatever, original_status, dst_status, status_flag, dst_context])
            elif speaker == 'done':
        ...
        # Convert results to DataFramecalendar_convert.xlsx
        ...
        excel_output_path = 'final_result/results-' + file + '.xlsx'
